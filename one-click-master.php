...
Final Class OneClickMaster {
    ...
    private function define_constants() {
        ...
        define( 'OCM_ROOT_DIR_PATH', plugin_dir_path( __FILE__ ) );
        define( 'OCM_ADMIN_DIR_PATH', OCM_ROOT_DIR_PATH . '/admin' );
    ...
    public function ocm_enqueue_scripts() {
        ...
        if( is_admin() ) {
            ...
            wp_enqueue_script( 'ocm-sweetalert-js', OCM_ADMIN_URL . "/assets/js/sweetalert2.js", [ 'jquery' ], filemtime( OCM_ADMIN_DIR_PATH . '/assets/js/sweetalert2.js' ), true );
